...
<footer class="footer">
    <div class="fadbg">
        <div class="securesction">
            <div class="container">
                <ul class="row securelist mb-0">
                    <li class="col-12 col-sm-4 col-lg-4">
                        <div class="box">
                            <div class="mb-4"><img class="icon-img icon-white" src="<?php echo $siteurl; ?>/assets/images/icons/033-service.png" alt="logo" /></div>
                    ...
                    <li class="col-12 col-sm-4 col-lg-4">
                        <div class="box">
                            <div class="mb-4"><img class="icon-img icon-white" src="<?php echo $siteurl; ?>/assets/images/icons/032-satisfaction.png" alt="logo" /></div>
                    ...
                    <li class="col-12 col-sm-4 col-lg-4">
                        <div class="box">
                            <div class="mb-4"><img class="icon-img icon-white" src="<?php echo $siteurl; ?>/assets/images/icons/037-secure-payment-1.png" alt="logo" /></div>
            ...
            <div class="row mt-3">
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    <h6 class="text-uppercase fw-bold mb-4">
                        <a class="" href="index.php"><img class="img-fluid flogo" src="<?php echo $siteurl; ?>/assets/images/trp-logo.png" alt="logo" /></a>
                    </h6>
        ...
        <div class="copyright">Copyright © 2014-2023 The Rainbow Print. All Rights Reserved. Design and Developed by SRE.</div>
    </div>
...
<!-- <script src="<?php echo $siteurl; ?>/assets/js/all.min.js"></script> -->
<script type="text/javascript" src="<?php echo $siteurl; ?>/assets/js/bootstrap.bundle.min.js"></script>
<script type="text/javascript" src="<?php echo $siteurl; ?>/assets/js/owl.carousel.min.js"></script>
